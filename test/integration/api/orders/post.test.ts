...
describe("POST /api/orders", () => {
  test("with valid data, whitout customer, coupon and cond_pag", async () => {
    ...
    expect(responseBody).toHaveProperty("id_order");
    expect(responseBody.pre_name).toBe(orderData.pre_name);
    expect(responseBody.pre_email).toBe(orderData.pre_email);
    expect(responseBody.pre_cpf_cnpj).toBe(orderData.pre_cpf_cnpj);
    expect(responseBody.id_user).toBe(orderData.id_user);
