...
export const sendPDFOrderEmail = ({
  ...
  const urlPDF = `${baseUrl}/pdf/order/${id_order}`;
      ...
      <Tailwind>
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Text>
              Olá, {name ? toTitleCase(name.split(" ")[0]) : ""}! Que alegria
              poder ajudar você a planejar sua próxima aventura! Preparamos tudo
              com muito carinho e atenção para tornar esse processo o mais
              simples e inspirador possível. Confira abaixo o link do seu
              orçamento:
            </Text>
