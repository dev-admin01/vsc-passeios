      ...
      <Tailwind>
        <Body className="bg-white my-auto mx-auto font-sans px-2">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] max-w-[465px]">
            ...
            <Text>
              Olá, {name ? toTitleCase(name) : ""}! Esse é o último passo para
              você finalizar o seu pedido e poder aproveitar a sua viagem.
              Preparamos tudo com muito carinho e atenção para tornar esse
              processo o mais simples e inspirador possível. Confira abaixo o
              link para efetuar o cadastro:
            </Text>
            <Link href={`${urlDoc}`}>Efetuar cadastro</Link>
            <br />
            <br />
            <Text>
